package com.capshot.capshotassignmentnew.Widgets;
...
public class MotionView  extends FrameLayout {
    ...
    private void init(@NonNull Context context) {
        ...
        selectedLayerPaint.setAlpha((int) (255 * Constant.OPACITY_OF_IMAGE));
    ...
    public void addEntityAndPosition(@Nullable MotionEntity entity, boolean isStartOfActivity) {
        if (entity != null) {
            initEntityBorder(entity);
            if(!isStartOfActivity)
                initialTranslateAndScale(entity);
            else
                firstImageTranslateAndScale(entity);
            entities.add(entity);
    ...
    private void firstImageTranslateAndScale(@NonNull MotionEntity entity) {
        entity.moveToCanvasCenter();
        entity.getLayer().setScale(1.3F);
    }
